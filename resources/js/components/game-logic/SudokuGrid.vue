<template>
  <ul
    class="bg-gray-600/50 p-[0.125rem] sm:p-1 min-w-50 rounded-lg max-w-7xl 2xl:max-w-[90rem] w-fit h-fit grid justify-items-center place-items-center gap-[0.1rem]  md:gap-1  sudoku"
    :style="maxValueStyle"
  >
    <li
